...
df_source_schema = StructType([
                    ...
                    StructField("vsdate", StringType()),
                    StructField("status", StringType()),
                    StructField("tmind", StringType()),
                    StructField("des", StringType()),
                    StructField("shdes", StringType()),
                    StructField("plcode", StringType()),
                    StructField("plmnname", StringType()),
                    StructField("tmrc", StringType()),
                    StructField("rec_version", StringType()),
                    StructField("apdate", StringType()),
                    StructField("tmglobal", StringType()),
                    StructField("currency", StringType()),
                    StructField("global_iot_ind", StringType()),
